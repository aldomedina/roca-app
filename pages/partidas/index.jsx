...
const mock_partidas = [
  {name: "Misterios de los iliadis", slug:'misterios-de-los-iliadis', id: 10}
]
    ...
    <div>
      ...
      <MainWrapper border="grey" scroll>
        <GridContainer bgImg fullH>
          <GridChild column={1} columnSpan={'end'} row={1} rowSpan={2} bgColor={'white'} border="grey" bbnone>
          ...
          {
            !!mock_partidas && !!mock_partidas.length && mock_partidas.map((p,i) => (
              <GridChild key={`party-${i}`} column={1} columnSpan={'end'} row={"auto"} rowSpan={2} bgColor={'white'} border="grey" bbnone={mock_partidas.length!==i+1}>
